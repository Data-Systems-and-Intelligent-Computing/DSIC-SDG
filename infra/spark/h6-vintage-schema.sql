CREATE NAMESPACE IF NOT EXISTS kkciv.research;

CREATE TABLE IF NOT EXISTS kkciv.research.release_vintages (
  vintage_id STRING NOT NULL,
  source_id STRING NOT NULL,
  source_channel STRING NOT NULL,
  vintage_date DATE NOT NULL,
  vintage_basis STRING NOT NULL,
  retrieved_at TIMESTAMP NOT NULL,
  release_label STRING NOT NULL,
  source_manifest_path STRING NOT NULL,
  source_manifest_sha256 STRING NOT NULL
) USING iceberg
TBLPROPERTIES (
  'format-version'='2',
...
CREATE TABLE IF NOT EXISTS kkciv.research.indicator_observations (
