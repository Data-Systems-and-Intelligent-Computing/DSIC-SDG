...
| `05-hasil.md` | Hasil | H15 Jalur A dan C, 13 September 2026 |
...
Hasil sudah ditulis pada H15 dan tabel serta gambarnya disusun dari sumber ber-checksum melalui
`make h15-run`. Metode sudah ditulis pada H12 dan memuat bagian ancaman terhadap validitas, termasuk tiga
...
divariasikan. Pembahasan dan Kesimpulan belum ditulis dan berada di luar jendela tiga minggu ini.
